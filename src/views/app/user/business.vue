      ...
      <form>
        <ul>
          <li @click="sheetVisible = true">
            <label>工作时间</label>
            <input v-model="livingType" maxlength="11" placeholder="请选择您的工作时间">
          </li>
        </ul>
      </form>
    </div>
    ...
    <div class="ui-form">
      <form>
        <ul>
          <li>
            <label>经营主体</label>
            <input class="noBackground" v-model="address" maxlength="11" placeholder="请填写经营主体名称">
          </li>

          <li class="wid" @click="getCity">
            <label>现单位地区</label>
            <input v-model="livingPlace" maxlength="11" placeholder="请选择现单位所在地区">
          </li>
          <li>
            <label>详细地址</label>
          ...
          <li class="noBorder">
            <label>单位电话</label>
            <input class="noBackground" v-model="years" maxlength="11" placeholder="区号">
            <input class="noBackground" v-model="years" maxlength="11" placeholder="电话号码">
            <input class="noBackground" v-model="years" maxlength="11" placeholder="分机号">
          </li>
        </ul>
      </form>
    </div>
